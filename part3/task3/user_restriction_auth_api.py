#!/usr/bin/python3
"""
Users API endpoints with JWT authentication and restrictions
"""
...
@users_bp.route('/me/places', methods=['GET'])
@jwt_required()
def get_user_places():
    """
    ...
    try:
        current_user = get_jwt_identity()
        places = facade.get_places_by_owner(current_user['id'])
...
def get_user_reviews():
    ...
    try:
        current_user = get_jwt_identity()
        reviews = facade.get_reviews_by_user(current_user['id'])
